...
_`Last Updated: 3/7/2026`_ [`edit`](https://github.com/dandalpiaz/dandalpiaz.github.io/edit/main/README.md) <button id="light-toggle" onclick="toggleLight()" aria-label="toggle color mode">🌗</button>
